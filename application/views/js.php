...
=======
	        ...
	        // END Retrieve Laboratory List


	        // Delete Laboratory Module
	       	$("#deleteLab").click(function(){
	       		console.log("labtodelete "+currentLab );
	       		if(labEquipments.length==0){
		       		$.ajax({
						url: "<?php echo site_url('Laboratory/deleteLab');?>",
						type: 'POST',
						data: {'labID':currentLab},						
						success: function(data){
								console.log("Laboratory "+this.currentLab+" Successfully Deleted");							
								}
					});
					location.reload();
				}else{
...
=======
		       		if(validLab==true && $("#labName").val().length != 0){
>>>>>>> Modified 1/03/2017 Validations+Bug Fixes
		       			$.ajax({
							...
							success: function(data){
<<<<<<< HEAD
								console.log("Laboratory successfully added.");							
...
>>>>>>> Modified 1/03/2017 Validations+Bug Fixes
			...
			if($("input[name=item]:checked").val() === "equipment"){
				$.ajax({
					...
					success: function(data){
<<<<<<< HEAD
						console.log("Equipment "+ $("#eqpName").val() +" successfully added to laboratory.");
...
=======
				...
				if($("#eqpSerialNum").val().length == 0){
					$("#eqpSerialNum").html("Laboratory name cannot be empty");
				}
>>>>>>> Modified 1/03/2017 Validations+Bug Fixes
				$.ajax({
...
<<<<<<< HEAD
						...
						console.log("Compponent "+$("#eqpName").val()+" successfully added to laboratory.");
...
<<<<<<< HEAD
		        		...
		        		console.log($("#editName").val()+" successfully updated.");
...
<<<<<<< HEAD
	                  		...
	                  		console.log($("#currLab").val()+" labEquipments "+data);
...
=======
		        		$("#repairModalHeader").html(	
		        		 '<th>Equipment</th><th>Date Reported</th><th>Check All <input type="checkbox" class="repairAll" onclick = "checkAllRepair()"></th>');
		        		var repairEqp = '';
>>>>>>> Modified 1/03/2017 Validations+Bug Fixes
		        		for(var i = 0; i < data.length; i++){
...
=======
		        		$("#repairEquipments").html(repairEqp);	
		        	}else{
					 		$("#repairEquipments").html('<tr><td>No Damaged Equipment(s)...</td><td></td></tr>');
>>>>>>> Modified 1/03/2017 Validations+Bug Fixes
		        	}
	        	}
	        });
...
>>>>>>> Modified 1/03/2017 Validations+Bug Fixes
		...
		function checkAllRepair(){
			...
			if($("#repairModalHeader .repairAll").is(':checked')){
				for(var i = 0; i < items.length; i++){
		...
		function clearRepairAll(){
			if($("#repairModalHeader .repairAll").is(':checked')){
				$("#repairModalHeader .repairAll").prop('checked', false);
			}
		}
